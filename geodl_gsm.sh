...
#using aspera
    ftpurl="/xchip/cogs/tools/bin/aspera-connect/bin/ascp -o Overwrite=never -QT -q -l 100M -i /xchip/cogs/tools/bin/aspera-connect/etc/asperaweb_id_dsa.putty anonftp@ftp-private.ncbi.nlm.nih.gov:/pub/geo/DATA/supplementary/samples"
    else
#for wget
